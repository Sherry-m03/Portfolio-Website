...
export default function CineLogOld() {
...
function NavBar({ children }) {
  return <nav className="cineL-nav-bar">{children}</nav>;
}
...
function Main({ children }) {
  return (
    <>
      <main className="cineL-main">{children}</main>
    </>
  );
}
...
function Box({ children }) {
  ...
  return (
    <div className="cineL-box">
      <button
        className="cineL-btn-toggle"
...
function MovieList({ movies, onSelectMovie }) {
  return (
    <ul className="cineL-list cineL-list-movies">
      {movies?.map((movie) => (
      ...
      {isLoading ? (
        ...
        <>
          <header>
            ...
            <div className="cineL-details-overview">
              <h2>{title}</h2>
              <p>
